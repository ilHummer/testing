! function(e, r) {
    ...
    return function(e) {
            ...
            function g(e) {
                ...
                var r = this,
                            ...
                            for (var f, l = t[Symbol.iterator](); !(i = (f = l.next()).done); i = !0) {
                                ...
                                if (Array.isArray(p)) Array.isArray(o) || (o = []), o = [].concat(g(o), g(p));
                                    ...
                                    var d = !0,
                                        ...
                                        y = void 0;
                                    try {
                                        for (var m, w = Object.entries(p)[Symbol.iterator](); !(d = (m = w.next()).done); d = !0) {
                                            var x = m.value,
                                                E = s(x, 2),
                                                O = E[0],
                                                S = E[1];
                                            b(S) && Reflect.has(o, O) && (S = e(o[O], S)), o = u({}, o, v({}, O, S))
                                        }
                                    } catch (e) {
                                        h = !0, y = e
                                    } finally {
                    ...
                    A = function() {
                        function e(r, t) {
                            ...
                            if (l(this, e), this._retryCount = 0, this._options = u({
                                    ...
                                    retry: 2
                                }, y), w && (this.abortController = new m, this._options.signal && this._options.signal.addEventListener("abort", function() {
                            ...
                            if (this._options.prefixUrl && !this._options.prefixUrl.endsWith("/") && (this._options.prefixUrl += "/"), this._input = this._options.prefixUrl + this._input, v) {
                                var b = new URL(this._input, o && o.baseURI);
                                if ("string" == typeof v || URLSearchParams && v instanceof URLSearchParams) b.search = v;
                                else {
                                    if (!Object.values(v).every(function(e) {
                                            return "number" == typeof e || "string" == typeof e
                                        })) throw new Error("The `searchParams` option must be either a string, `URLSearchParams` instance or an object with string and number values");
                                    b.search = new URLSearchParams(v).toString()
                                }
                                this._input = b.toString()
                            }
                            ...
                            var R = function() {
                                ...
                                A = void 0;
                            try {
                                for (var I, P = O[Symbol.iterator](); !(N = (I = P.next()).done); N = !0) {
                                    C(I.value)
                                }
                            } catch (e) {
                                _ = !0, A = e
                        ...
                        return a(e, [{
                            ...
                            value: function(e) {
                                if (this._retryCount++, this._retryCount < this._options.retry && !(e instanceof C)) {
                                    if (e instanceof j) {
                                    ...
                                    return regeneratorRuntime.wrap(function(e) {
                                        for (;;) switch (e.prev = e.next) {
                                            ...
                                            case 25:
                                                return e.finish(18);
                                            case 26:
                                                return e.abrupt("return", _(y(this._input, this._options), this._timeout, this.abortController));
                                            case 27:
                                            case "end":
                                                return e.stop()
                                        }
                    ...
                    I = function e() {
                        ...
                        if (!b(r) || Array.isArray(r)) throw new TypeError("The `defaultOptions` argument must be an object");
                        var t = function(e, t) {
                ...
                e.default = I, e.HTTPError = j, e.TimeoutError = C, Object.defineProperty(e, "__esModule", {
                    value: !0
                })
            })
        }).call(this, t(5))
        ...
        var a = t(0).get,
            u = t(9).serializeMessage,
            s = t(24),
            c = s.fetchUserCode,
            f = s.fetchUserCodeAsync,
            l = t(53).runUserCode,
            p = t(68),
            d = t(70).isWebWorker,
            v = t(71),
            ...
            m = t(3),
            b = t(8),
            w = t(73).createFedopsLogger,
            x = t(2).convertToDeveloperConsoleSeverity,
            E = t(74).active$wBiFactoryCreator,
            O = t(75).createUserCodeMapWithEnrichedUrls,
            S = function(e) {
                return function(r) {
                    if ("ASSERT" !== r.logLevel || !r.args[0]) {
                        var t = Object.assign({}, r, {
                            logLevel: x(r.logLevel)
                        });
        ...
        e.exports.create = function(e) {
            var r = e.appLogger,
                ...
                j = function() {
                    var e = i(regeneratorRuntime.mark(function e(n) {
                        var o, i, a = n.wixCodeApi,
                            u = n.userCodeMap,
                            s = n.isWebWorker,
                            l = n.viewMode,
                            p = n.codePackagesData;
                        return regeneratorRuntime.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (o = O({
                                    ...
                                    return e.next = 4, c(a.telemetry ? a.telemetry.console : t, r, k, o, g);
                                case 4:
                                    e.t0 = e.sent, e.next = 10;
                                    break;
                                case 7:
                                    return e.next = 9, f(r, o, h);
                                case 9:
                                    e.t0 = e.sent;
                                case 10:
                                    return i = e.t0, "Site" === l && u.length && r.bi(b.userCodeLoaded({
                                        pageId: u[0].id
                                    })), e.abrupt("return", i);
                                case 13:
                                case "end":
                ...
                C = function() {
                    var e = i(regeneratorRuntime.mark(function e(n) {
                        var i, c, f = n.wixCodeApi,
                            l = n.userCodeMap,
                            d = n.isWebWorker,
                            v = n.codePackagesData;
                        return regeneratorRuntime.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return y.setExtraHeaders(f, r), i = a(f, ["window", "viewMode"]), s && (f.telemetry ? (c = function(e) {
                                        var r = e.reason || {},
                                            t = new Error;
                                        "object" === (void 0 === r ? "undefined" : o(r)) ? (t.message = r.message || r.name, t.stack = r.stack || t.stack) : t.message = r, f.telemetry.console.error(t)
                                    }, self.addEventListener("unhandledrejection", c)) : (x = p.wrapConsole(t), R = p.handlePromiseRejections(), "Site" !== i && (x(S(f)), R(S(f)))), s = !1), e.next = 5, j({
                                        wixCodeApi: f,
                                        userCodeMap: l,
                                        isWebWorker: d,
                                        viewMode: i,
                ...
                N = function(e) {
                    var t = e.wixCodeApi,
                        n = e.reportTrace,
                        o = e.biLoggerFactory,
                        i = e.fedOpsLoggerFactory,
                        u = e.createRavenClient,
                        s = e.userCodeMap,
                        c = e.isWebWorker,
                        f = a(t, ["user", "currentUser", "id"]),
                        l = a(t, ["window", "viewMode"]);
                    r.init({
                        user: {
                            id: f
                        },
            ...
            return {
                initAppForPage: function() {
                    var e = i(regeneratorRuntime.mark(function e(t, n, o, i) {
                        var a, u, s, c, f, l, p, v, g;
                        return regeneratorRuntime.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.prev = 0, a = t.appData, u = a.userCodeMap, s = a.codePackagesData, c = i.biLoggerFactory, f = i.fedOpsLoggerFactory, l = i.monitoring, p = i.reportTrace, v = m.initAppForPage(), (k = w(f)).interactionStarted(v.actionName), g = d(), N({
                                        wixCodeApi: o,
                                        reportTrace: p,
                                        biLoggerFactory: c,
                            ...
                            return function(e) {
                                ...
                                if (u.size > 0) {
                                    var y = E({
                                        ...
                                        b = l({
                                            userConsole: a.telemetry ? a.telemetry.console : t,
                                            appLogger: r,
                                            fedopsLogger: k,
                                            active$wBiFactory: y,
                                            instance: c,
                                    ...
                                    v = !1, a.events.setStaticEventHandlers(b)
                                }
                                return []
                            }(e)
                        });
            ...
            runUserCode: function() {
                ...
                try {
                    ...
                    if (m && !p.telemetry && i({
                            ...
                            instance: h,
                            onLog: y,
                            ignoredConsoleMessages: n(x)
                        }), 0 === g.length) return {};
                    var E = a(p, self.fetch.bind(self), l.wrapObjectPropertiesWithBi),
                        O = l.wrapFunctionReturnValueWithBi(d);
                    O.at = l.wrapFunctionCallWithBi(d.at, d);
                    var S = g.map(function(e) {
                        r && r.info && r.info(x[e.scriptName]);
                        var n = {};
                        if (v.has(e.url)) {
                            try {
                                var i = v.get(e.url);
        ...
        var v = function(e) {
            ...
            y = function() {
                var e = o(regeneratorRuntime.mark(function e(r) {
                    var t, n, a, u, s, c, d, y, m, b, w = r.appLogger,
                        x = r.fedopsLogger,
                        E = r.wixSdk,
                        O = r.instance,
                        S = r.onLog,
                        ...
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 7:
                                return a = p({
                                    ...
                                    appLogger: w
                                }), y = d.sendLogThrottled, m = function() {
                                    var e = o(regeneratorRuntime.mark(function e(r) {
                                        var t, n = r.message,
                                            o = r.severity,
                                            i = r.sourceLocation;
        ...
        e.exports = {
            wrapConsole: function(e) {
                ...
                if (e) {
                    ...
                    for (var s in u)
                        if (u.hasOwnProperty(s) && e.hasOwnProperty(s)) {
                            var c = p(e, u[s], e[s], n);
                            e[s] = c
                        }
                    var f = p(e, i.VERBOSE, o, n);
                    e.verbose = f
                }
                return t
            },
            ...
            active$wBiFactoryCreator: function(e) {
                var r = e.appLogger,
                    ...
                    w = function(e) {
                        ...
                        var r = function() {
                                for (var r = arguments.length, t = Array(r), n = 0; n < r; n++) t[n] = arguments[n];
                                return y() ? b(e.apply(this, t), 2) : e.apply(this, t)
                            },
                            t = !0,
                            o = !1,
                            i = void 0;
...
//# sourceURL=https://static.parastorage.com/services/wix-code-viewer-app/1.1479.539/app.js